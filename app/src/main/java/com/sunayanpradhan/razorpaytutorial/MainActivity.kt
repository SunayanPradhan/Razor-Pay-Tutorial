package com.sunayanpradhan.razorpaytutorial
...
class MainActivity : AppCompatActivity(), PaymentResultListener {
    ...
    private fun paymentProcess(amount: Int) {
        ...
        checkout.setKeyID("rzp_test_mK9wYK6RfOJARJ")
        ...
        try {
            ...
            options.put("name","Techno Sp")

            options.put("description","Make a payment")

            options.put("image","https://miro.medium.com/max/775/0*rZecOAy_WVr16810")
